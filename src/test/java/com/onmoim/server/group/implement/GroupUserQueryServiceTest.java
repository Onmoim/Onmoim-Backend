...
@SpringBootTest
@Transactional
public class GroupUserQueryServiceTest {
	...
	void getJoinedGroups() {
		...
		groupUserRepository.save(GroupUser.create(matchedGroup, user, Status.MEMBER));
		...
		CommonCursorPageResponseDto<GroupSummaryResponseDto> response =
			groupUserQueryService.getJoinedGroups(null, 10);
